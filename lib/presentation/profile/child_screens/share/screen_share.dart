...
//   const ScreenShare({Key? key}) : super(key: key);

//   void _shareLink() {
//     Share.share('https://your-link.com', subject: 'My EcoStance Page');
//   }
...
//                               label: const Text(
//                                   'Share EcoStance Page'), // Button text
...
// Add this class to your existing widget tree
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // ... other widgets
          ScreenShare(), // Include the ScreenShare widget
          // ... other widgets
        ],
      ),
    );
