...
class RatingBar extends StatefulWidget {
  ...
  const RatingBar({
    ...
    this.wrapAlignment = WrapAlignment.start, required this.allowUpdate,
  })  : _itemBuilder = null,
  ...
  /// Defines whether or allow to update or not
  ///
  /// Default is false.
  ...
  Widget _buildRating(BuildContext context, int index) {
    ...
    return IgnorePointer(
      ...
      child: GestureDetector(
        ...
        onHorizontalDragStart: widget.allowUpdate ?  _isHorizontal ? _onDragStart : null:null,
        onHorizontalDragEnd: widget.allowUpdate ? _isHorizontal ? _onDragEnd : null:null,
        onHorizontalDragUpdate: widget.allowUpdate ? _isHorizontal ? _onDragUpdate : null:null,
        onVerticalDragStart: widget.allowUpdate ? _isHorizontal ? null : _onDragStart:null,
        onVerticalDragEnd: widget.allowUpdate ? _isHorizontal ? null : _onDragEnd:null,
        onVerticalDragUpdate: widget.allowUpdate ? _isHorizontal ? null : _onDragUpdate:null,
        child: Padding(
